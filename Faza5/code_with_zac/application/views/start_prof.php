...
<html>
	<head>
		<title> CodeWithZac(Home-Profesor)</title>
...
In this jam-packed 1 hour course, we focus on the tools, techniques and ideas you can use to inspire fun and creativity in programming. With an emphasis on applications, the course steers away from code syntax or the conventions of any specific language and keeps the focus on making coding fun. In fact you won't need any background or knowledge in programming at all.</font> 
		...
		<hr>
                ...
                <div class="row" align="center">
                    <div class="col-sm-3">
                        <font size="6" face="Cursive"><u><b>Professor privileges</u></b></font>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row" align="center">
                    <div class="col-sm-3">
                         <font size="4" face="Cursive"><u><a href="<?php echo site_url('Profesor/ucitaj_biranje_njaboljeg') ?>">Choose the best student in this month</a></u></font>                    </div>
				...
				<font size="4" face="Cursive"><u><a href="<?php echo site_url('Profesor/ucitaj_dodavanje_pitanja') ?>">Add new questions for specific chapter</a></u></font></td>
                    </div>
				...
				<?php 
                    ...
                    <div class="col-sm-3" align="right">
                       <a href="<?php echo site_url("Profesor/ucitaj_komentare")?>"><input type="button" class="btn btn-info" value="View comments"></a>
                       <br>
                       <a href="<?php echo site_url("Profesor/ucitaj_rate")?>"><font size="4" face="Cursive">Rate this course <font/></a>
                       <br>
                ...
                <div class="row" id="soon">
                    <div class="col-sm-3" align="center">
                       <font size="4" face="Cursive"><u><a href="<?php echo site_url('Profesor/ucitaj_dodavanje_materijala') ?>">Add more about some chapter (documentation)</a></u></font></td>
