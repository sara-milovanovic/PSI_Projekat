	...
	<!--tabela uvod-->
		...
		<table >
			<tr>
				...
				<td bgcolor="edecd3"> <font size="5" face="Cursive"><a href="<?php echo site_url("Gost/ucitaj_faq")?>">Frequently Asked Questions</a></font></td>
...
In this jam-packed 1 hour course, we focus on the tools, techniques and ideas you can use to inspire fun and creativity in programming. With an emphasis on applications, the course steers away from code syntax or the conventions of any specific language and keeps the focus on making coding fun. In fact you won't need any background or knowledge in programming at all.</font></td>
		...
		<table width="100%" align="center" >
			<tr align="center">
				<td width="15%"></td>
				<td bgcolor="c1f3d8" width="40%" id="courses"> <font size="6" face="Cursive"><b>Courses<b/></font></td>
				<td width="35%"></td>
				<td></td>
			</tr>
			...
			<tr  align="center">
				<td></td>
				<td><img src="<?php echo base_url('images/c.png')?>" height="130"></td>
				<td></td>
				<td></td>
			</tr>
			<tr align="left">
			...
			<tr align="center">
				<td></td>
				<td><img src="<?php echo base_url('images/python.png')?>" height="130"></td>
				<td></td>
				<td></td>
			</tr>
			<tr align="left">
			...
			<tr align="center">
				<td></td>
				<td><img src="<?php echo base_url('images/scratch.jpg')?>" height="130"></td>
				<td></td>
		...
		<table align="right">
			<tr>
				<td bgcolor="edecd3">  <font size="4" face="Cursive"><a href="<?php echo site_url("Gost/ucitaj_faq")?>">FAQ/How to use<font/> </td>
