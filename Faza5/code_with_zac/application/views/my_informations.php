...
<html>
	...
	<!--tabela uvod-->
		...
		<table>
			<tr>
				<td  width="35%"> <font size="6"></font></td>
		...
		<!--<td> <font size="4" face="Cursive">
					<ul>
						...
						<li>Final test (random questions) ----------------------</li>
					</u>
					<font/>
				</td>
				<td> <font size="4" face="Cursive">
				...
				<table width='100%' >
					<tr >
						<td width="10%"></td>
						<td valign="bottom" width="15%" align="right">username:</td>
						<td width="25%" valign="bottom"><b><?php if(isset($username)) echo $username ?></b></td>
						<td width="40%">
							<img src="c.png" height="130">
							
						</td>
						<td width="20%"><img src="zac_score.png" height="130"></td>
					...
					<tr>
						...
						<td><b><?php if(isset($password)) echo $password ?></b></td>
					...
					<tr>
						...
						<td align='left'><b><?php if(isset($e_mail)) echo $e_mail ?></b></td>
					...
					<tr>
						...
						<td><b><?php if(isset($name)) echo $name ?></b></td>
					...
					<tr>
						...
						<td><b><?php if(isset($surname)) echo $surname ?></b></td>
