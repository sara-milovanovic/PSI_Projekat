	...
	<hr size="2" color="black">
		<table>
			<tr>
				...
				<td width="10%" align="right"> <button type="button" align="left"> <font size="4"><a href="LogIn.html">Log In</a></font></button> </td>
		...
		<table width='100%'>
			<tr>
				<td align='right' width='53%'>
					<button width='10%' height='10%' type='button' align='center'><font size='20'></font> <a href="LogIn.html">Confirm</a></button>
				</td>
				
				<td width='40%'>
					<button width='10%' height='10%' type='button' align='center'><font size='20'></font> <a href="start_unreg.html">Cancel</a></button>
				</td>
				<td width='30%'>
